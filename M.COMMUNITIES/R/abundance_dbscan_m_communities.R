#' 计算由dbscan聚类所产生小群落中的物种丰度 / Calculate the species abundance in the mirror communities generated by DBSCAN clustering
#' @description 计算由dbscan聚类所参数小群落中的物种丰度 / Calculate the species abundance in the mirror communities generated by DBSCAN clustering
