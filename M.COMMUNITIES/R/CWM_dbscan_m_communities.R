#' 计算由dbscan聚类所产生小群落的群落平均功能性状值 / Calculate the community mean functional trait values of the mirror communities generated by DBSCAN clustering
#' @description 计算由dbscan聚类所产生小群落的群落平均功能性状值 / Calculate the community mean functional trait values of the mirror communities generated by DBSCAN clustering
