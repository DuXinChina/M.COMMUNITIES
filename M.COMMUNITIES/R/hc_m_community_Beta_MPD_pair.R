#' 计算由hc聚类所产生小群落间的平均配对功能性状距离(SES.贝塔MPD) / Calculate the mean pairwise functional trait distance (SES beta MPD) between mirror communities generated by HC clustering
#' @description 计算由hc聚类所产生小群落间的平均配对功能性状距离(SES.贝塔MPD) / Calculate the mean pairwise functional trait distance (SES beta MPD) between mirror communities generated by HC clustering
